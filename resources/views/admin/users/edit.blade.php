...
<div class="admin-header"><i class="fas fa-user-edit" style="margin-right:0.5rem;"></i>Edit User</div>
<form id="user-edit-form" method="POST" action="{{ route('admin.users.update', $user) }}" class="user-form-card">
    @csrf
    @method('PUT')
    <label class="user-form-label">Name</label>
    <input type="text" name="name" class="user-form-input" value="{{ $user->name }}" required>
    <label class="user-form-label">Email</label>
    <input type="email" name="email" class="user-form-input" value="{{ $user->email }}" required>
    ...
    <input type="text" name="address" class="user-form-input" value="{{ $user->address }}" required>
    <label class="user-form-label">New Password (optional)</label>
    <input type="password" name="password" class="user-form-input">
    <label class="user-form-label">Confirm New Password</label>
    <input type="password" name="password_confirmation" class="user-form-input">
    <button type="submit" class="user-form-btn"><i class="fas fa-save"></i> Update User</button>
</form>
<script>
